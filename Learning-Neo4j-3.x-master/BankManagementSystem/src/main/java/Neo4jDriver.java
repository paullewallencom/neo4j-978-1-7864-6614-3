                ...
                switch (choice) {
                    case 1:
                    {
                        ...
                        do {
                            ...
                            switch (choice = Integer.parseInt(input.nextLine())) {
                                case 1: {
                                    int id; double initialAmount;
                                    String fullName, dateOfBirth, phoneNumber;

                                    System.out.print("Enter new id for customer: ");
                                    ...
                                    bank.createAccount(id, fullName, dateOfBirth, phoneNumber, initialAmount);
                                    System.out.println("-----------------------------------------------");
                                    break;
                                }
                                case 2: {
                                ...
                                case 3: {
                                    ...
                                    System.out.print("Enter the account number: ");
                                    int accNum = Integer.parseInt(input.nextLine());
                                    if(bank.searchAccount(id, accNum)) {
                                        String phoneNumber;

                                        System.out.print("Enter new phone number of customer(123-1111-123-1234): ");
                                        phoneNumber = input.nextLine();
                                        bank.updateAccountDetails(phoneNumber, id);
                                        System.out.println("-----------------------------------------------");
                                    }
                                    break;
                                }
                                case 4: {
                                    ...
                                    System.out.print("Enter the account number: ");
                                    int accNum = Integer.parseInt(input.nextLine());
                                    bank.printCustomerAccountDetails(id, accNum);
                                    break;
                                }
                                case 5:
                                {
                    ...
                    case 2:
                    {
                        ...
                        do {
                            ...
                            System.out.println("-----------------------------------");
                            if(bank.searchAccount(id, accountNumber)) {
                                break;
                            }
                            else {
                                counter--;
                        ...
                        do {
                            ...
                            switch (choice = Integer.parseInt(input.nextLine())) {
                                case 1: {
                                    ...
                                    bank.depositAmount(amount, accountNumber, id);
                                    System.out.println("-----------------------------------------------");
                                    break;
                                }
                                case 2: {
                                    ...
                                    amount = Double.parseDouble(input.nextLine());
                                    bank.withdrawAmount(amount, accountNumber, id);
                                    System.out.println("-----------------------------------------------");
                                    break;
                                }
                                case 3:
                                {
                                    bank.printCustomerAccountDetails(id, accountNumber);
                                    System.out.println("-----------------------------------------------");
                                    break;
                                }
                                case 4:
